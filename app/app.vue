<template>
  <UApp>
    <div class="min-h-screen w-full">
      ...
      <div class="mx-auto max-w-[47.5rem] p-6">
        
        <header>
          <nav class="flex justify-between w-full pt-5 pb-8">
            <div class="text-lg text-green-400 hover:text-green-200 tracking-widest font-bold uppercase spacing">
              <a href="/">Made Yoga</a>
            </div>
            
            <div class="text-gray-400 flex items-center gap-6 text-lg">
        ...
        <main>
          <section id="hero" class="py-16 flex gap-10">
            ...
            <div class="flex flex-col gap-6 justify-center h-full">
              <div>
                ...
                <h1 class="font-bold text-3xl text-gray-400 leading-[1.5]">
                  <span class="text-green-400">Hey, I'm Made.</span> I'm a Fullstack Software Developer.
                </h1>

              </div>

              <div class="w-full flex items-center justify-between text-gray-400">
                <div>
                  🏠 Samarinda, Indonesia.
                </div>
          ...
          <section id="techstack" class="py-16">
            <h2 class="uppercase tracking-widest text-white font-bold text-lg pb-12">Tech Stack</h2>

            <div class="grid grid-cols-5 gap-5 text-gray-400">
              <tech-stack-card title="Django">
                <svg fill="#fff" viewBox="0 0 128 128" height="48" width="48">
              ...
              <tech-stack-card title="JavaScript">
                <svg viewBox="0 0 128 128" height="48" width="48">
              ...
              <tech-stack-card title="Tailwind">
                <svg viewBox="0 0 128 128" height="48" width="48">
          ...
          <section id="workexperience" class="pt-16 pb-8">
            <h2 class="uppercase tracking-widest text-white font-bold text-lg pb-12">Work Experience</h2>

            <div class="flex gap-8 py-6">
              <div class="text-gray-400">2022 - 2025</div>

              <div>
                <h3 class="text-white">Backend Software Developer</h3>
                <div class="text-gray-400">Superjaya • <a class="text-green-400" href="https://superjaya.id" target="_blank">superjaya.id</a> • Freelance</div>
            ...
            <div class="flex gap-8 py-6">
              <div class="text-gray-400">2021 - 2025</div>

              <div>
                <h3 class="text-white">Fullstack Software Developer</h3>
                <div class="text-gray-400">PT Media Bersama Sukses • <a class="text-green-400" href="https://mbscctv.com" target="_blank">mbscctv.com</a> • Freelance</div>
            ...
            <div class="flex gap-8 py-6">
              <div class="text-gray-400">2024 - 2024</div>

              <div>
                <h3 class="text-white">Frontend Software Developer</h3>
                <div class="text-gray-400">PT. Nasional Bhirawa Tama • <a class="text-green-400" href="https://nasionalrubber.co.id/" target="_blank">nasionalrubber.co.id</a> • Freelance</div>
          ...
          <section id="projects" class="pt-16 pb-8">
            <h2 class="uppercase tracking-widest text-white font-bold text-lg pb-12">Projects</h2>
            ...
            <div class="flex justify-between">
              <div class="rounded-lg w-[640px] border border-light-gray border-gray-700 p-5 flex flex-col gap-5">
                ...
                <h3 class="font-semibold dark:text-white text-xl tracking-wide">mbscctv.com</h3>

                <p class="dark:text-gray-400">
                  Project Landing Page dari perusahaan PT Media Bersama Sukses. 
                  Website dilengkapi katalog product dan blog untuk update berita terbaru perusahaan.
                </p>
        ...
        <footer>
          <section id="contact" class="pt-6 pb-2 border-t-1 border-neutral-800">
            <div class="flex justify-between">
              ...
              <div class="text-gray-400">madeybog@gmail.com</div>
